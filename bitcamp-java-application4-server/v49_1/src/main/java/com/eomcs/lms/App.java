// v49_1 : CRUD 기능을 한 클래스에 모으기 + @RequestMapping 메서드를 별도로 관리 
...
public class App {
  ...
  public App() throws Exception {
    ...
    handlerMapping = createRequestMappingHanlderMapping();

  }

  private RequestMappingHandlerMapping createRequestMappingHanlderMapping() {
    RequestMappingHandlerMapping mapping = 
        new RequestMappingHandlerMapping();

    // 객체 풀에서 @Component 애노테이션이 붙은 객체 목록을 꺼낸다.
