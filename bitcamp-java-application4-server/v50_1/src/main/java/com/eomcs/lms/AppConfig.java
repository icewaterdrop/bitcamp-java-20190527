...
public class AppConfig {
  ...
  private SqlSessionFactory sqlSessionFactory() throws Exception {
    System.out.println("AppConfig.sqlSessionFactory() 호출 됨!");
    // Mybatis 객체 준비
  ...
  private PlatformTransactionManager transactionManager(
    ...
    System.out.println("AppConfig.transactionManager() 호출 됨!");
  ...
  private MybatisDaoFactory daoFactory(SqlSessionFactory sqlSessionFactory) throws Exception {
    System.out.println("Appconfig.daoFactory() 호출 됨!");
    // DAO 구현체 생성기를 준비한다.
  ...
  @Bean
  private BoardDao boardDao(MybatisDaoFactory mybatisDaoFactory) throws Exception{
    System.out.println("Appconfig.boardDao() 호출 됨");
    return mybatisDaoFactory.createDao(BoardDao.class);
  }
  
  @Bean
  private LessonDao lessonDao(MybatisDaoFactory mybatisDaoFactory) throws Exception{
    System.out.println("Appconfig.lessonDao() 호출 됨");
    return mybatisDaoFactory.createDao(LessonDao.class);
  }
  
  @Bean
  private MemberDao memberDao(MybatisDaoFactory mybatisDaoFactory) throws Exception{
    System.out.println("Appconfig.memberDao() 호출 됨");
    return mybatisDaoFactory.createDao(MemberDao.class);
  }
  
  @Bean
  private PhotoBoardDao photoBoardDao(MybatisDaoFactory mybatisDaoFactory) throws Exception{
    System.out.println("Appconfig.boardDao() 호출 됨");
    return mybatisDaoFactory.createDao(PhotoBoardDao.class);
  }
  
  @Bean
  private PhotoFileDao photoFileDao(MybatisDaoFactory mybatisDaoFactory) throws Exception{
    System.out.println("Appconfig.boardDao() 호출 됨");
