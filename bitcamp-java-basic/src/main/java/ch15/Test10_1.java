...
public class Test10_1 {
  public static void main(String[] args) {
    ...
    // 정수 값을 얻는다.
    // => 그렇게 리턴 받은 정수값(해시코드 )를 사용하여 Student 객체(의 주소)를 저장할 위치를 계산
    // => 그런 후 그위치에 해당하는 배열(배열로 관리한다면)에 저장한다.
