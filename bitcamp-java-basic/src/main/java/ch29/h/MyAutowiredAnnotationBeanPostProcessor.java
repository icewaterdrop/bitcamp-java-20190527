...
public class MyAutowiredAnnotationBeanPostProcessor implements BeanPostProcessor {
  ...
  private Object getBean(Class<?> type) {
    ...
    return objList.get(0); // 객체 목록에서 첫번째 객체를 꺼낸다.
  }
  ...
  public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
    ...
    private void addAutowiredMethod (
      ...
      // 해당 의존 객체에 대해 나중에 호출하기위해 모아둔 메서드 목록을 꺼낸다 호출할 메서드 목록을 꺼낸다.
    ...
    private void callAutowiredMethod(Object bean) {
      ...
      // public 메서드 중에서 @Authowired로 표시된 메서드를 찾는다.
      for (Method m : methods) {
        ...
        if (dependency !=null ) {// 해당 의존객체가 있다면 
          //셋터를 호출한다.
          try {
