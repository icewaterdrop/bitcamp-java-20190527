...
public class Test01_3 {
  ...
  public static void main(String[] args) {
    ...
    // RuntimeException을 발생 시키는 메서드를 호출할 때
    // 예외 처리 코드를 작성하지 않더라도
    // 컴파일러는 에러를 띄우지 않는다
    ...
    while (true) {
      try {
        ...
        // 그러나 예외는 예외이기 때문에 발생하는 순간 호출자게에 전달한다.
        // main()에서 발생된 예외는 JVM에게 바로 전달 되기 때문에
        // 즉시 실행을 멈출 것이다.
        // 그래서 예외처리가 강제 사항이 아니라 할지라도
        // 이렇게 try ~ catch ~ 로 처리한것이다.
        ...
        System.out.println("입력 또는 계산중에 오류 발생!");
      }
    }
  }
