...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    // 이렇게 Patient의 경우처럼 컴퓨터에서 다루기위해 데이터화하여 정의 하는 것을
    // "추상화"라 부른다.
    // 꼭 데이터만 해당하는 것은 아니다.
    // MemberHandler 클래스의 경우처럼 특정 업무를 정의하는 것도 
    // "추상화"라 부른다.
    // => 즛 실세계의 객체(예: 사람, 물건, 업무 등)를 컴퓨터에서 다룰 수 있도록 
    ...
    // "추상화"가 무너지게 된다.
    // 이름 방지하기 위해서는 클래스 목적(추상화 목적)에 맞춰
    // 인스턴스의 변수에 무효한 값이 들어가지 않도록 해야 한다.
    // 그럴 목적으로 만든 문법이 캡술화이다.
