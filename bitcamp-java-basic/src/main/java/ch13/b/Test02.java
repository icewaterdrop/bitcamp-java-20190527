...
public class Test02 {
  public static void main(String[] args) {
    ...
    s2.setName("임꺽정");
    s2.setMusic(100); // Score2의 compute() 호출 => 5과목의 합계와 평균 계산
    s2.setArt(100); // Score2의 compute() 호출  => 5과목의 합계와 평균 계산
    ...
    // 국, 영, 수 점수를 설정할 때는Score의 compute()호출한다.
    // 음악, 미술 점수를 설정할 때는 Score2의 compute2()를 호춫한다.
    // 따라서 음악, 미술 점수를 먼저 설정한 다음에 국, 영, 수 점수를 설정하면
    // 합계와 평균이 잘못 계산 된다.
    //
    //해결책!
    // 1) 국, 영, 수 점수를 설정하는 setter에서 compute() 대신에 compute2를 호출 하도록 변경
